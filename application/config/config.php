...
$config['view_page_source']      = 'sections/';
$config['platform']              = 'phpSFP - Schedule facebook posts v.1.9.5';
$config['facebook_call']         = '';
$config['facebook_app_id']       = '';
$config['facebook_app_secret']   = '';
$config['facebook_app_version']  = '';
...
|
*/
$config['encryption_key'] = 'DFASJ1HDF2SJDFASHDAS4364DC334CDW';
