...
class Faceboook extends CI_Model {
    ...
    function settings($id_user = false)
    {
        ...
        if($qsettings_general->num_rows() > 0)
        {
            ...
            $this->app_version    = $qsettings_general->row()->app_version;
        ...
        if($qsettings->num_rows() > 0)
        {
            ...
            if($qsettings->row()->app_default == 1 && empty($admin))
            {
                ...
                $this->app_version    = $qsettings->row()->app_version;
                $this->app_general    = 0;
    ...
    function fbdata($user_id, $action = false, $groups = false)
    {
        ...
        if($qfbdata->num_rows() > 0)
        {
            if($action == 'update')
            {
                ...
                if(in_array($this->app_version, array('v2.4', 'v2.5', 'v2.6', 'v2.7', 'v2.8')) && empty($groups))
                {
    ...
    function check_token_permissions()
    {
        ...
        if(!empty($permissions) && is_array($permissions) && !isset($permissions['error']))
        {
            ...
            if(in_array($this->app_version, array('v2.4', 'v2.5', 'v2.6', 'v2.7', 'v2.8')))
            {
    ...
    function import_groups()
    {
        if(isset($_POST))
        {
            ...
            if(!empty($file))
            {
                ...
                // ALRAZAMC - I warn you if you copy my code again I will send a DMCA and I will sue you!!!
                $patterns[] = '/id:"(\d+)",name:"([^"]+)",count:([^"]+),counttype:"([^"]+)",datagt:"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"([^"]+)\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/id:"(\d+)",name:"([^"]+)",count:([^"]+),counttype:"([^"]+)",datagt:"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/"id":"(\d+)","name":"([^"]+)","count":([^"]+),"counttype":"([^"]+)","datagt":"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/"id":"(\d+)","name":"([^"]+)","count":([^"]+),"counttype":"([^"]+)","datagt":"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"([^"]+)\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/"id":"(\d+)","name":"([^"]+)","count":([^"]+),"counttype":"([^"]+)","datagt":"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/id:"(\d+)",name:"([^"]+)",count:([^"]+),counttype:"([^"]+)",datagt:"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"([^"]+)\\",\\"post_name_icon\\":\\"([^"]+)\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/id:"(\d+)",name:"([^"]+)",count:([^"]+),counttype:"([^"]+)",datagt:"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"\\",\\"post_name_icon\\":\\"\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/"id":"(\d+)","name":"([^"]+)","count":([^"]+),"counttype":"([^"]+)","datagt":"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"\\",\\"post_name_icon\\":\\"\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/"id":"(\d+)","name":"([^"]+)","count":([^"]+),"counttype":"([^"]+)","datagt":"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"([^"]+)\\",\\"post_name_icon\\":\\"([^"]+)\\",\\"bookmark_type\\":\\"type_group\\"/';
                $patterns[] = '/"id":"(\d+)","name":"([^"]+)","count":([^"]+),"counttype":"([^"]+)","datagt":"{\\"bmid\\":\\"([^"]+)\\",\\"count\\":\\"([^"]+)\\",\\"count_details\\":\\"\\",\\"post_name_icon\\":\\"\\",\\"bookmark_type\\":\\"type_group\\"/';
                ...
                foreach($patterns as $pattern)
                {
                    ...
                    if(isset($matches[1]) && isset($matches[2]) && isset($matches[3]))
                    {
                        foreach($matches[1] as $key => $row)
                        {
                            ...
                            $sgroups[$matches[1][$key]]['id']   = $matches[1][$key];
                            $sgroups[$matches[1][$key]]['name'] = isset($decode[0])? $decode[0]:$matches[2][$key];
                        }
                    }
                }
